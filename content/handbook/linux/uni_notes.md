...
For synchronisation, [Syncthing](https://syncthing.net) is a common solution; it is an encrypted peer-to-peer file sync tool. It was pleasantly easy to set up; localhost pops up and lets you (symmetrically) connect to any other local device also running Syncthing. 
...
I also wanted them backed up on Git.
...
I've also found myself more spurred to take high quality notes because I know they're being tracked (I am my own panopticon). This solution also makes your Git commit history look very impressive after a day of study, though not publicly.
