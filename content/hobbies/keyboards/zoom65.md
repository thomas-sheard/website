...
Within each of these sizes, there are variations for the actual composition of keys within it. Most keyboards in Australia follow the ANSI (American National Standards Institute) layout, whereas the layout from the International Organisation for Standardisation (ISO) of Switzerland, commonly used in Europe, has a larger enter key spanning two rows and language-accommodating modifications for symbols and diacritics (like AltGr, which sits to the right of the spacebar and allows access to various currency symbols). Standardisation as a whole is an [interesting topic](https://www.youtube.com/watch?v=nAsrsMPftOI).
...
I did have the foresight to take photos throughout the process but they are... wonky. Apologies. 
